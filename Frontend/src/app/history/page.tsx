...
import {getUserWatchHistory} from '@/api/auth';
...
export default function Home() {
  ...
  useEffect(() => {
    const getMovies = async (page = 1) => {
      try {
        setIsLoading(true);
        const response = await getUserWatchHistory(page);
  ...
  return (
    <div className="pt-16 min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white">
      <div className="container mx-auto py-8">
        <h1 className="text-4xl font-extrabold mb-6 text-center">Your watch history</h1>
